...
### 1.1. 开发者
在描述开发者关系之前，不得不提一个概念“开发者”。众所周知开发者即软硬件开发人员，我们称之为开发人员、研发人员、程序员或工程师。然而在企业发展开发者过程中的服务对象，却存在叫大的争议：
...
### 1.2. 开发者关系
DevRel是一个总称，建立和培育企业与作为主要用户的开发者（例如，软件开发人员）之间互利关系社区的战略和策略，并影响产品的购买，用于确保一个人的公司、产品和开发人员通过相互沟通与外部开发人员建立良好、持续的关系。
